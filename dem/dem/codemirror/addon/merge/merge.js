...
(function(mod) {
  ...
  function foundNearbyDiff(cm, dir) {
  ...
  function goNearbyDiff(cm, dir) {
  	var found = foundNearbyDiff(cm, dir);
    if (found != null)
  ...
  CodeMirror.commands.foundNextDiff = function(cm) {
  	return foundNearbyDiff(cm, 1) != null;
  }

  CodeMirror.commands.foundPrevDiff = function(cm) {
  	return foundNearbyDiff(cm, -1) != null;
  }
